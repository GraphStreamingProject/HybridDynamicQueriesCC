...
def process_dataset(
    ...
    for sys_name in SYSTEM_NAMES:
        ...
        data["Update Speed (100k/s)"][sys_name] = np.nan
        data["Query Speed (100k/s)"][sys_name] = np.nan
    ...
    for manifest in manifest_paths:
        ...
        try:
            ...
            data["Space (GB)"][sys_name] = peak_bytes / 1e9
        except ValueError:
            pass
        ...
        try:
            ...
            data["Update Speed (100k/s)"][sys_name] = ups / 100000.0
        except ValueError:
            pass
        ...
        try:
            ...
            data["Query Speed (100k/s)"][sys_name] = query_ups / 100000.0
        except ValueError:
            pass
...
def main():
    ...
    for ds in datasets:
        ds_data = process_dataset(ds, args.revision_dir, args.cupcake_dir)
    ...
    for metric_name, cmap, filename in metrics_config:
        ...
        sns.heatmap(
            df,
            annot=True,
            fmt=".1f" if "Speed" in metric_name else ".2f",
            cmap=cmap,
            linewidths=0.5,
            ax=ax,
